...
async def _translate(ctx: discord.ApplicationContext, language: Option('language', choices = [OptionChoice(name='en', value='EN'), OptionChoice(name='de', value='DE')]), text: Option(str, "Enter text to translate.")):
